'''
Train PredNet on UCSD sequences. All hyperparameters that are defined 
here are associated with UCSD dataset.
'''
...
def run_training(subdir, hyperparams):
    ...
    N_seq_val = hyperparams['N_seq_val']  # number of sequences to use for validation
...
def fix_hyperparams():
    '''
    Helper function to fix hyperparameters for training our model.
    Returns a dict that can be fed to the run_training method.
    '''
    hyperparams = dict()
    hyperparams['nb_epoch'] = 50
    hyperparams['batch_size'] = 4
    hyperparams['samples_per_epoch'] = 600# 900, 600, 250
    hyperparams['N_seq_val'] = 80#100, 80, 30  # number of sequences to use for validation
    hyperparams['old_learning_rate'] = 0.001
    hyperparams['new_learning_rate'] = 0.0003
    hyperparams['epoch_learning_rate_number'] = 30
    hyperparams['sz1'] = 32 #48
    hyperparams['sz2'] = 64 #96
    hyperparams['sz3'] = 128 #192
    hyperparams['fz'] = 3
    return hyperparams
